...
const weatherOptions = [
  ...
  { icon: MoonStar, value: 'moonStar', label: '달과 별' },
  { icon: CloudMoon, value: 'cloudMoon', label: '구름 낀 달' },
  { icon: Sunrise, value: 'sunrise', label: '일출' },
  { icon: Sunset, value: 'sunset', label: '일몰' },
  { icon: Cloud, value: 'cloudy', label: '흐림' },
  { icon: Cloudy, value: 'veryCloudy', label: '매우 흐림' },
  ...
  { icon: ThermometerSun, value: 'veryHot', label: '매우 더움' },
  { icon: Thermometer, value: 'hot', label: '더움' },
  { icon: ThermometerSnowflake, value: 'veryCold', label: '매우 추움' },
